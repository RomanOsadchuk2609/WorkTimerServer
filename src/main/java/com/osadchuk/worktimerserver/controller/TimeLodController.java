...
public class TimeLodController {
	...
	@PostMapping("/create")
	@ResponseBody
	public TimeLog createNewTimer(@AuthenticationPrincipal UserDetails userDetails,
		...
		if (user.isPresent()) {
			...
			return timeLogService.save(timeLog);
		} else {
			return null;
		}
	}
	...
	@PostMapping("/stop")
	@ResponseBody
	public TimeLog stopWork(@AuthenticationPrincipal UserDetails userDetails,
